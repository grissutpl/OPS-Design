...
#        plt.xlabel(r"$\bf{" + 'Longitud\,(m)' + "}$\n\n${Elaborado\,\,por:\,Daniel\,\,Villarreal\,\,Leiva}$")
        ...
        plt.plot((xi, xf), (yi, yf), color='#003F72' if ingreso_datos[i][1] == "Column" else "#A71930", linewidth=4) 
    
        anotations = plt.annotate(f"Element: {ingreso_datos[i][1]} {ingreso_datos[i][0]}\n{ingreso_datos[i][13]} - {ingreso_datos[i][14]}",
                     ...
                     xytext= (0, -15) if ingreso_datos[i][1] == "Beam" else (5, 0), #--> Ajusta la ubicación del texto
                     ha='center' if ingreso_datos[i][1] == "Beam" else "left", 
                     va="center")
#    
...
#                     va="center")
        ...
        if slope == 0:
            ...
            if ingreso_datos[i][1] == 'Beam' and abs(ingreso_datos[i][15]) > 0:
            ...
            if ingreso_datos[i][1] == 'Beam' and abs(ingreso_datos[i][21]) > 0:
            ...
            if ingreso_datos[i][1] == 'Beam' and abs(ingreso_datos[i][16]) > 0:
...
def frame_a(ingreso_datos_a):
    ...
    for i in range(len(ingreso_datos_a)): 
        ...
        plt.title('Frame\nOption with the lowest possible complexity index\n',fontsize=14, fontweight='bold')
#        plt.xlabel(r"$\bf{" + 'Longitud\,(m)' + "}$\n\n${Elaborado\,\,por:\,Daniel\,\,Villarreal\,\,Leiva}$")
        ...
        plt.plot((xi, xf), (yi, yf), color='#003F72' if ingreso_datos_a[i][1] == "Column" else "#A71930", linewidth=4) 
    
        anotations = plt.annotate(f"Element: {ingreso_datos_a[i][1]} {ingreso_datos_a[i][0]}\n{ingreso_datos_a[i][13]} - {ingreso_datos_a[i][14]}",
                     xy=(xi + (xf - xi) / 2, yi + (yf - yi) / 2), #--> Mis anotaciones estarán en medio de la línea
                     textcoords="offset points", #--> Junto con la línea anterior, me ubica en medio de la línea
                     xytext= (0, -15) if ingreso_datos_a[i][1] == "Beam" else (5, 0), #--> Ajusta la ubicación del texto
                     ha='center' if ingreso_datos_a[i][1] == "Beam" else "left", 
                     va="center")
#    
...
#                     va="center")
        ...
        if slope == 0:
            ...
            if ingreso_datos_a[i][1] == 'Beam' and abs(ingreso_datos_a[i][15]) > 0:
                plt.plot((xi, xf), (yi+wd_height, yf+wd_height), color='green', linewidth=1) 
            ...
            if ingreso_datos_a[i][1] == 'Beam' and abs(ingreso_datos_a[i][21]) > 0:
            ...
            if ingreso_datos_a[i][1] == 'Beam' and abs(ingreso_datos_a[i][16]) > 0:
...
#        plt.xlabel(r"$\bf{" + 'Longitud\,(m)' + "}$\n\n${Elaborado\,\,por:\,Daniel\,\,Villarreal\,\,Leiva}$")
        ...
        plt.plot((xi, xf), (yi, yf), color='#003F72' if ingreso_datos_b[i][1] == "Column" else "#A71930", linewidth=4) 
    
        anotations = plt.annotate(f"Element: {ingreso_datos_b[i][1]} {ingreso_datos_b[i][0]}\n{ingreso_datos_b[i][13]} - {ingreso_datos_b[i][14]}",
                     xy=(xi + (xf - xi) / 2, yi + (yf - yi) / 2), #--> Mis anotaciones estarán en medio de la línea
                     textcoords="offset points", #--> Junto con la línea anterior, me ubica en medio de la línea
                     xytext= (0, -15) if ingreso_datos_b[i][1] == "Beam" else (5, 0), #--> Ajusta la ubicación del texto
                     ha='center' if ingreso_datos_b[i][1] == "Beam" else "left", 
                     va="center")
#    
...
#                     va="center")
        ...
        if slope == 0:
            ...
            if ingreso_datos_b[i][1] == 'Beam' and abs(ingreso_datos_b[i][15]) > 0:
                plt.plot((xi, xf), (yi+wd_height, yf+wd_height), color='green', linewidth=1) 
            ...
            if ingreso_datos_b[i][1] == 'Beam' and abs(ingreso_datos_b[i][21]) > 0:
            ...
            if ingreso_datos_b[i][1] == 'Beam' and abs(ingreso_datos_b[i][16]) > 0:
