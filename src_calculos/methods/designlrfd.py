...
def disenioLRFD(ExcelPrincipal, ingreso_datos, F_elementos, D_optimizator, perfiles_aprobados):
    ...
    for i in range(len(ingreso_datos)):
        ...
        if lamb_f < lamb_rf:
            Ala_C = 'Ala No  Esbelta'
        
        else:
            Ala_C = 'Ala Es  Esbelta'
        ...
        if lamb_w < lamb_rw:
            Alma_C = 'Alma No Esbelta'
        
        else:
            Alma_C = 'Alma Es Esbelta'
        ...
        *np.sqrt(caracteristicas [i][29]/f)),2)
        ...
        if Ala_C == 'Ala Es  Esbelta' and Alma_C == 'Alma No Esbelta':
            Q = 1
        elif Ala_C == 'Ala No  Esbelta' and Alma_C == 'Alma Es Esbelta':
            Q = 1
        elif Ala_C == 'Ala No  Esbelta' and Alma_C == 'Alma No Esbelta':
            Q = 1
        else:
            Q = round(Qs*Qa,2)
        Q_lista.append(Q)
        ...
        if Ala_C == 'Ala No  Esbelta' and Alma_C == 'Alma No Esbelta':
            
            TipoSeccion_Compresion = 'Sección No Esbelta'
            
            if KLR_diseno <= 4.71*np.sqrt(caracteristicas [i][29]/(caracteristicas [i][28])):
                
                FormaPandeo_Compresion = 'Pandeo Inelástico Secciones No Esbeltas'
                ...
                FormaPandeo_Compresion = 'Pandeo Elástico   Secciones No Esbeltas'
            ...
            TipoSeccion_Compresion = 'Sección Es Esbelta'
            
            if KLR_diseno <= 4.71*np.sqrt(caracteristicas [i][29]/(Q*caracteristicas [i][28])):
                
                FormaPandeo_Compresion = 'Pandeo Inelástico Secciones    Esbeltas'
                ...
                FormaPandeo_Compresion = 'Pandeo Elástico   Secciones    Esbeltas'
    ...
    for i in range(len(ingreso_datos)):
        ...
        *(np.sqrt(1+0.078*((caracteristicas [i][24]*c)/(caracteristicas [i][10]*caracteristicas [i][25]))*((Longitudes[i]/caracteristicas [i][27])**2))),2)
        ...
        if lamb_f < lamb_pf:
            Ala_F = 'Ala Es Compacta'
            
        elif lamb_f < lamb_prf and lamb_f > lamb_pf:
            Ala_F = 'Ala No Compacta'
            
        elif lamb_f > lamb_prf:
            Ala_F = 'Ala Es  Esbelta'  
        ...
        if lamb_w < lamb_pw:
            Alma_F = 'Alma Compacta'
            
        elif lamb_w < lamb_prw and lamb_w > lamb_pw:
            Alma_F = 'Alma No Compacta'
        ...
        if Ala_F == 'Ala Es Compacta' and Alma_F == 'Alma Compacta':
            
            TipoSeccion_Flexion = 'La Sección Si Es Compacta Tanto En Las Alas Como En El Alma'
            ...
            if Longitudes[i] <= Lp:
                ZonaPandeo_Flexion = 'Pandeo Por Momento Plástico Total   (Zona 1)'
                
                Mnx_LTB = 'No Aplica'
                
            elif Lp < Longitudes[i] < Lr:
                ZonaPandeo_Flexion = 'Pandeo Lateral Torsional Inelastico (Zona 2)'
                
                Mnx_LTB = round(Cb*(Mpx-(Mpx-0.7*caracteristicas [i][28]*caracteristicas [i][10])*((Longitudes[i]-Lp)/(Lr-Lp))),2)
                    
            elif Longitudes[i] >= Lr:
                ZonaPandeo_Flexion = 'Pandeo Lateral Torsional Elastico   (Zona 3)'
        ...
        elif Ala_F == 'Ala No Compacta' and Alma_F == 'Alma Compacta':
            
            TipoSeccion_Flexion = 'La Sección Es No Compacta En Las Alas Y Compacta En El Alma' 
        ...
        elif Ala_F == 'Ala Es  Esbelta' and Alma_F == 'Alma Compacta':
            
            TipoSeccion_Flexion = 'La Sección Si Es  Esbelta En Las Alas Y Compacta En El Alma'
        ...
        if TipoSeccion_Flexion == 'La Sección Si Es Compacta Tanto En Las Alas Como En El Alma':
            Mnx = [Mnx_Y, Mnx_LTB]
            Mnx = min(item for item in Mnx if isinstance(item, numbers.Number))
            
        elif TipoSeccion_Flexion == 'La Sección Es No Compacta En Las Alas Y Compacta En El Alma':
            Mnx = [Mnx_LTB, Mnx_FLB]       
            Mnx = min(item for item in Mnx if isinstance(item, numbers.Number))
            
        elif TipoSeccion_Flexion == 'La Sección Si Es  Esbelta En Las Alas Y Compacta En El Alma':
            Mnx = [Mnx_LTB, Mnx_FLB]    
            Mnx = min(item for item in Mnx if isinstance(item, numbers.Number))
    ...
    for i in range(len(ingreso_datos)):
        ...
        if Ala_F == 'Ala Es Compacta':
            
            TipoSeccion_Flexion_Y = 'Sección Es Compacta En Las Alas (No se Considera el Alma)'
            
            Mny_Y = round(Mpy,2)
            Mny_FLB = 'No Aplica'
            
        elif Ala_F =='Ala No Compacta':
            
            TipoSeccion_Flexion_Y = 'Sección No Compacta En Las Alas (No se Considera el Alma)'    
            Mny_Y = round(Mpy,2)
            Mny_FLB = round(Mpy-(Mpy-(0.7*caracteristicas [i][29]*caracteristicas [i][16]))*((lamb_f-lamb_pf)/(lamb_rf-lamb_pf)),2)
            
        elif Ala_F =='Ala Es  Esbelta':
            
            TipoSeccion_Flexion_Y = 'Sección Es Esbelta  En Las Alas (No se Considera el Alma)'
            Mny_Y = round(Mpy,2)
        ...
        if (TipoSeccion_Flexion_Y == 'Sección Es Compacta En Las Alas (No se Considera el Alma)' or 
            TipoSeccion_Flexion_Y == 'Sección No Compacta En Las Alas (No se Considera el Alma)' or 
            TipoSeccion_Flexion_Y == 'Sección Es Esbelta  En Las Alas (No se Considera el Alma)'):
    ...
    for i in range(len(ingreso_datos)):
        ...
        if ingreso_datos[i][1] == 'Col':
            ...
            Verificacion = 'Por Acciones Combinadas De Flexo Compresión'
            Demanda_Capacidad = 0
        ...
        elif ingreso_datos[i][1] == 'Vig':
            
            Verificacion = 'Acciones De Flexión Solicitante En Elementos'
