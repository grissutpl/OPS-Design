...
from src_calculos.methods.mselection import selectionBeamCol
from src_calculos.motor.validation import constraintValidation
...
def optimalframe(D_optimizator, D_criterio, D_nodos_totales, D_nodos_restringidos, ExcelPrincipal, DatosPrincipales, Perfil_Data):
    ...
    my_console = Logger('src_calculos/files/optimice_motor.txt') 
...
#        lista_posibles_combinaciones = []
    ...
    if len(lista_los_mejores) != 0:
        ...
        print('\n','Diseños óptimos representativos:')
        if len(list_variabilidad_final) >= 1:
            print('\n',"1.- índice de complejidad constructiva más bajo:",'\n')
        ...
        print("NO EXISTE UNA OPCIÓN OPTIMA")
    ...
    print('\n','✔✔✔ El proceso de optimización ha finalizado con éxito, cierre esta ventana y proceda ahora a ver los resultados ✔✔✔','\n')
