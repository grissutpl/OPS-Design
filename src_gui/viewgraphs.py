...
from PyQt5.QtWidgets import QMainWindow, QApplication, QComboBox, QTableWidgetItem, QMessageBox, QDialog
...
from Gui.images_viewer import Ui_Dialog

# C L A S S   
# ¯¯¯¯¯¯¯¯¯

class InfoImage(QDialog, Ui_Dialog):
